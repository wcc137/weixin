 ...
 *@公司：          前景科技
 *@系统名称：changing
 *@文件名称：EncodingSet.java
 *@功能描述:
 *@创建人  ：zn
 *@创建时间: 2011-8-5 下午03:19:15
 *@完成时间：2011-8-5 下午03:19:15
 *@修该人：
 *@修改内容：
 *@修改日期：
 */
...
public class EncodingSet implements Filter {
	 ...
	 * filter initialization parameters. If no character encoding should be set, return <code>null</code>. <p> The
	 * default implementation unconditionally returns the value configured by the <strong>encoding</strong>
